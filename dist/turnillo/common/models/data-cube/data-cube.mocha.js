...
const data_cube_fixtures_1 = require("./data-cube.fixtures");
describe("DataCube", () => {
    ...
    describe("#addAttributes", () => {
        ...
        it("works with existing dimension", () => {
            ...
            chai_1.expect(dataCube.toJS().measures.map(m => m.name)).to.deep.equal(["deleted"]);
        });
    });
...
//# sourceMappingURL=data-cube.mocha.js.map